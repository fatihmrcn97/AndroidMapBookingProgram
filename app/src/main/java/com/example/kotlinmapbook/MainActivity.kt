...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        try {
            ...
            val latitudeIndex= cursor.getColumnIndex("latidue")
            ...
            while (cursor !=null){
                ...
                val latidueCoordinate = latitudeFromDatabase.toDouble()
                val longitudeCoordinate = longitudeFromDatabase.toDouble()

                val location = LatLng(latidueCoordinate,longitudeCoordinate)
        ...
        val arrayApadter = ArrayAdapter(this,android.R.layout.simple_list_item_1,namesArray)
        listView.adapter=arrayApadter
        ...
        listView.setOnItemClickListener { adapterView, view, i, l ->
            ...
            intent.putExtra("latiude",locationArray[i].latitude)
